...
static NSString *const CLEAR_ALL_SQL = @"DELETE from %@";//清除表数据
static NSString *const DELETE_TABLE_SQL = @"DROP TABLE %@"; //删除表
...
- (void)deleteTable:(NSString *)tableName {
    ...
    NSString * sql = [NSString stringWithFormat:DELETE_TABLE_SQL, tableName];
    __block BOOL result;
    [_dbQueue inDatabase:^(FMDatabase *db) {
        result = [db executeUpdate:sql];
    }];
